...
// Send a 409 Conflict response, along with a plain-English error message
...
// Send a 401 Unauthorized if user is not authorized
...
// Send a 403 Forbidden if user is not activated
func (app *application) inactiveAccountResponse(w http.ResponseWriter, r *http.Request) {
	message := "your user account must be activated to access this resource"
	app.errorResponse(w, r, http.StatusForbidden, message)
}

// Send a 403 Forbidden if user is not have the permissions
